...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="#"></a> Update Data Dosen Dalam</li>
  </ol>
</section>
    ...
    <div class="col-md-12">
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Update Data Dosen Dalam</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <?php foreach ($dosenDalam as $p) { ?>
          <form action="<?= base_url('dosen_dalam/update'); ?>" method="post" class="form-horizontal">
            <div class="box-body">                    
              <div class="form-group">
                <label class="col-sm-2 control-label">Nama Dosen Dalam</label>
                <div class="col-sm-10">
                  <input type="hidden" class="form-control" value="<?= $p->id_dosendalam;?>" name="id_dosen">
                  <input type="text" class="form-control" value="<?= $p->nama_dosendalam;?>" name="dosen">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="number" class="form-control" value="<?= $p->honor_dosendalam;?>" name="honor_dosen">
