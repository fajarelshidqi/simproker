...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="#"></a> Tambah Data Dosen Luar</li>
  </ol>
</section>
    ...
    <div class="col-md-12">
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Tambah Data Dosen Luar</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <form action="<?= base_url('dosen_luar/add'); ?>" method="post" class="form-horizontal">
          <div class="box-body">                    
            <div class="form-group">
              <label class="col-sm-2 control-label">Nama Dosen Luar</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" placeholder="Masukan Nama Dosen Luar" name="dosen">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="number" class="form-control" placeholder="Rp. 0,-" name="transport">
                <?= form_error('transport', '<small class="text-danger">', '</small>'); ?>
              </div>
            </div>        
            <div class="form-group">
