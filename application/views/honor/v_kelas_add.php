...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="#"></a> Tambah Data Kelas</li>
  </ol>
</section>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-default">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form action="<?= base_url('kelas/add'); ?>" method="post" class="form-horizontal">
          <div class="box-body">
            <div class="form-group">
              <label class="col-sm-2 control-label">Kelas</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" placeholder="Masukan Nama Kelas" name="kelas">
