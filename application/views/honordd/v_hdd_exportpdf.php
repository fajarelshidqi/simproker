						...
						<table class="tabel" cellpadding="4" cellspacing="2" bgcolor="#ffffff" width="100%">			
							<thead>								
								<tr bgcolor="#99CCFF" style="color:#000000; text-align:center"> 
									...
									<th rowspan="2">Pert</th>
									<th rowspan="2">Jam</th>
									<th rowspan="2">Honor <br>(Rp.)</th>
									<th rowspan="2">Transport <br>(Rp.)</th>
							...
							<tbody>
								...
								foreach ($honordd2 as $k) { 
									$jml_honor = $k->honor_dosenluar * $k->jam; 
									$jml_transport = $k->transport * $k->pertemuan;									
									$total = $jml_honor + $jml_transport;
									?>
									<tr>
										<td class="tabel" style="text-align:center"><?php echo $no++;?></td>
										<td class="tabel"><?php echo $k->nama_mk;?></td>
										<td class="tabel"><?php echo $k->nama_dosenluar;?></td>
										<td class="tabel" style="text-align:center"><?php echo $k->pertemuan;?></td>
										<td class="tabel" style="text-align:center"><?php echo $k->jam;?></td>
										<td class="tabel" style="text-align:right"><?php echo number_format($jml_honor,0,'','.');?></td>
										<td class="tabel" style="text-align:right"><?php echo number_format($jml_transport,0,'','.');?></td>
									...
									<?php $totaljumlah += $total; ?>							
								<?php } ?>
								<tr>
									<td class="tabel" colspan="7" style="text-align:center"><b>Jumlah</b></td>
