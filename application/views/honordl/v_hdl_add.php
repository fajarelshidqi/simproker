...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="#"></a> Tambah Data Honor Dosen Luar</li>
  </ol>
</section>
    ...
    <div class="col-md-12">
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Tambah Data Honor Dosen Luar</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <form action="<?= base_url('honor_dosen_luar/add'); ?>" method="post" class="form-horizontal">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select class="select2 form-control" name="dosen" required="">
                  <option selected="selected" disabled="">- Pilih Nama Dosen Luar -</option>
                  <?php foreach ($dosenluar as $d) { ?>
                    <option value="<?= $d->id_dosenluar ?>"><?= $d->nama_dosenluar; ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
