...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="#"></a> Update Data Honor Dosen Luar</li>
  </ol>
</section>
    ...
    <div class="col-md-12">
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Update Data Honor Dosen Luar</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <?php foreach ($hdl as $k) { ?>
        <form action="<?= base_url('honor_dosen_luar/update'); ?>" method="post" class="form-horizontal">
          <div class="box-body">
            <div class="form-group">
              <label class="col-sm-2 control-label">Mata Kuliah</label>
              <div class="col-sm-10">
                <input type="hidden" name="id_honordl" value="<?= $k->id_honor_dosenluar;?>">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select class="select2 form-control" name="dosen" required="">
                  ...
                  <?php foreach ($dosenluar as $d) { ?>
                    <option value="<?= $d->id_dosenluar ?>" <?php if($d->nama_dosenluar==$k->nama_dosenluar){echo "selected='selected'";} ?>><?= $d->nama_dosenluar; ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
