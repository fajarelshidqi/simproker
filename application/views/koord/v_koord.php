...
<section class="content-header">
  <h1>
    Data Honor Koord MK
    <small>Mengelola Data Honor Koord MK</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="<?= base_url('home') ?>"><i class="fa fa-home"></i> Home</a></li>
    <li><a href="#"></a> Data Honor Koord MK</li>
  </ol>
</section>
    ...
    <div class="col-md-2">
      <div class="box box-default">
        <div class="box-header text-center">
          <h4 class="box-title">Filter Honor Koord MK</h4>
        </div>
        <div class="box-body">
          <form action="" method="get">
            ...
            <div class="box-footer">
              ...
              <div class="form-group">
                <a href="<?=base_url('koord')?>" class="btn btn-default btn-block"><span class="fa fa-refresh"></span> REFRESH</a>
              </div>
            </div>
          </form>
        </div>
    ...
    <div class="col-md-10">
      ...
      <div class="box box-default">
        <div class="box-header">
          ...
          <a href="<?= base_url('koord/add'); ?>" class="btn btn-primary"><span class="fa fa-plus"></span> Data Honor Koord MK</a>
          <?php 
          if(isset($_GET['bulan1']) || isset($_GET['bulan2']) || isset($_GET['kelas'])) {
            ...
            ?>
            <a href="<?=base_url().'koord/exportPdf/?bulan1='.$bulan1.'&bulan2='.$bulan2.'&kelas='.$kelas; ?>" class="btn btn-danger pull-right" target="_blank"><span class="fa fa-file-pdf-o"></span> Export Filter to PDF</a>
          <?php } ?>
        ...
        <div class="box-body">
          <table id="data" class="table table-bordered table-striped">
            ...
            <tbody>
              <?php
              $no = 1;
              foreach ($koord as $m) { $jumlah = 0; $jumlah = $m->honor_mk * $m->sks; ?>
                <tr>
                  <td><?php echo $no++; ?></td>
                  ...
                  <td>
                    <a href="<?= base_url('koord/edit/') . $m->id_koord; ?>" class="btn btn-success btn-xs" title="Edit"><i class="fa fa-edit"></i></a> | 
                    <a href="<?= base_url('koord/hapus/') . $m->id_koord; ?>" onclick="return confirm('Apakah yakin data peserta ini di hapus?')"  class="btn btn-danger btn-xs" title="Hapus"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
              <?php } ?>
            </tbody>
