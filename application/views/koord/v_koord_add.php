...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="#"></a> Tambah Data Honor Koordinator MK</li>
  </ol>
</section>
    ...
    <div class="col-md-12">
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Tambah Data Honor Koordinator MK</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <form action="<?= base_url('koord/add'); ?>" method="post" class="form-horizontal">
          <div class="box-body">
