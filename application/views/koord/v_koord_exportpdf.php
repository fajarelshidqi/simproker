	...
	<div class="container">
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="row">
					<div class="col-md-12">
						<h4 align="center">HONOR KOORDINATOR MENGAJAR AKBID <?php echo $koord->nama_kelas; ?> <br> BULAN <?php echo strtoupper($koord->bulanpertama); ?> <br> DIBAYARKAN BULAN <?php echo strtoupper($koord->bulankedua); ?></h4>	
						<table class="tabel" cellpadding="4" cellspacing="2" bgcolor="#ffffff" width="100%">			
							<thead>								
								<tr bgcolor="#99CCFF" style="color:#000000; text-align:center"> 
									...
									<th rowspan="2">Honor (Rp.)</th>
									<th rowspan="2">Total <br>Penerimaan (Rp.)</th>
							...
							<tbody>
								...
								foreach ($koord2 as $k) { $jumlah = $k->honor_mk * $k->sks; ?>
									<tr>
										<td class="tabel" style="text-align:center"><?php echo $no++;?></td>
										<td class="tabel"><?php echo $k->nama_mk;?></td>
										<td class="tabel" style="text-align:center"><?php echo $k->sks;?></td>
										<td class="tabel"><?php echo $k->nama_dosendalam;?></td>
										<td class="tabel" style="text-align:right"><?php echo number_format($k->honor_mk,0,'','.');?></td>
								...
								<tr>
									<td class="tabel"></td>
									<td class="tabel"></td>
									<td class="tabel" style="text-align:center"><b><?php echo $totalsks; ?></b></td>
									<td class="tabel"></td>
									<td class="tabel"></td>
