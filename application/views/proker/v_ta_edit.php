...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="#"></a> Update Data Tahun Ajaran</li>
  </ol>
</section>
    ...
    <div class="col-md-12">
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Update Tahun Ajaran</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <form action="<?= base_url('ta/update'); ?>" method="post" class="form-horizontal">
          <div class="box-body">
            <div class="form-group">
              <label class="col-sm-2 control-label">Tahun Ajaran</label>
              <div class="col-sm-10">
                <?php foreach($ta as $a) { ?>
                <input type="hidden" class="form-control" name="id_ta" value="<?= $a->id_ta;?>">
                <input type="text" class="form-control" placeholder="Masukan Tahun Ajaran Baru" name="ta" value="<?= $a->tahun_ajaran;?>">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                ...
                <button type="submit" class="btn btn-primary" title="Simpan Data"><span class="fa fa-save"></span> Update</button>
              </div>
            </div>
          </div>
        </form>
